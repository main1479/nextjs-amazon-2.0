...
function CheckoutProduct(props) {
	...
	return (
		<div className="grid grid-cols-5">
			<Image src={props.image} width={200} height={200} objectFit="contain" alt={props.title} />
			<div className="col-span-3 mx-5">
				<p>{props.title}</p>
				<Stars rating={props.rating.rate} />
				...
				{props.rating.rate > 4 && (
					<div className="flex items-center space-x-2 ">
						<img className="w-14" loading="lazy" src="https://i.ibb.co/F31MxVb/image.png" alt="" />
